...
public class PaymentService {
    ...
    public Payment createPaymentForBooking(Long bookingId, BigDecimal amount, Payment.PaymentMethod paymentMethod, String notes) {
    ...
    public boolean hasPaymentForOrder(Long orderId) {
